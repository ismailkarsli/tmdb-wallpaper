		...
		<form class="mt-5" @submit.prevent="onSubmit">
			<div class="ml-12">
				<label class="block">
					...
					<input v-model="settings.tmdb_api_key" class=" bg-gray-500 px-2 py-2 border border-gray-700 text-white rounded  text-sm  h-7 w-[400px]  mt-2 block
				...
				<div class="mt-2">
					<label class="block">
						...
						<div class="flex justify-self-center items-center mt-3  ">
							...
							<label class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">İzleme
								listesi</label>
					...
					<label class="block">
						...
						<div class="flex justify-self-center items-center mt-3">
							...
							<div v-if="!settings.filter_photos_with_text">
								<input type="checkbox" v-model="settings.language_of_photos"
									class="
									w-4 h-4 ml-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
								<label class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Yazı
									Dili</label>
							</div>
				...
				<div class="mt-2">
					<label class="block">
						...
						<div class="items-center">
							...
							<input type="number" v-model="settings.width" class=" bg-gray-500 px-2 py-2  border border-gray-700 text-white rounded  text-sm  h-7 w-64  mt-2 block
						focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500" />
							<label class=" text-sm font-medium text-gray-900 dark:text-gray-300">Yükseklik</label>

							<input type="number" v-model="settings.height" class=" bg-gray-500 px-2 py-2  border border-gray-700 text-white rounded  text-sm  h-7 w-64  mt-2 block
						focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500
						" />
						</div>
				...
				<div class="mt-2">
					<button type="submit"
						class="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">Kaydet</button>
				</div>
			</div>
		</form>
	</div>
